...
const FooterComponent = () =>{
  return(
    <div className={footerStyles.container}>
      ...
      <Row>
        <Col className={footerStyles.col} lg={2}><Image className={footerStyles.logo} src="../assets/logo.png" /></Col>
        ...
        <div className={footerStyles.fbdiv}><Image className={footerStyles.icon} src="../assets/facebook.png" /></div>
        <div className={footerStyles.instadiv}><Image className={footerStyles.fb} src="../assets/instagram.png" /></div>
